function [h,axh, xp,yp,zp] = plot_gaussian_ellipsoid(m, C, sdwidth, npts, axh)
...
switch numel(m)
   ...
   case 3, [h, axh, xp,yp,zp] =show3d(m(:),C,sdwidth,npts,axh);
   otherwise
...
%-----------------------------
function [h, axh, xp,yp,zp] = show3d(means, C, sdwidth, npts, axh)
